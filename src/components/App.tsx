...
function AppContent() {
  ...
  const [journeysCreateMode, setJourneysCreateMode] = useState(false);
    ...
    >
      ...
      <div className="w-full max-w-6xl px-4 sm:px-6 pt-5 flex flex-col gap-4 sm:gap-5">
                ...
                {activeTab === 'dashboard' && (
                  <ErrorBoundary name="Dashboard">
                    <Dashboard currency={settings.currency}
                      ...
                      onOpenJourneys={() => { setJourneysCreateMode(false); setShowJourneysManager(true); }}
                      onCreateJourney={() => { setJourneysCreateMode(true); setShowJourneysManager(true); }}
                      onEditTrip={(trip) => {
                        setEditingTrip(trip);
        ...
        <JourneysManager
          ...
          startInCreateMode={journeysCreateMode}
